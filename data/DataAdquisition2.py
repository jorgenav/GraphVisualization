...
if __name__ == '__main__':
    ...
    while not origin_stored:
        try:
            ...
            dict_json['followers'] = key_store.api.GetFollowerIDs(screen_name=u_origin.screen_name)
        ...
        for u2 in following:
            if (u.id == u2) and (not u.protected):
                try:
                    ...
                    # Almacenamiento de seguidores del usuario
                    dict_json['followers'] = key_store.api.GetFollowerIDs(screen_name=u.screen_name)
